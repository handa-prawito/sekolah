                            ...
                            <div class="">
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        <h4 class="card-title">Video <a href="{{ route('backend-video.create') }}" class="btn btn-primary">Tambah</a></h4>
                                    </div>
                                                ...
                                                @foreach ($video as $key => $videos)
                                                    <tr>
                                                        ...
                                                        <div style="display: flex; gap: 4px">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $videos->id }}">Hapus</button>
                                                        </div>
                                                        </td>
                                                    </tr>
                                                    <!-- Modal Konfirmasi Hapus -->
                                                    <div class="modal fade" id="deleteModal{{ $videos->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $videos->id }}" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="deleteModalLabel{{ $videos->id }}">Konfirmasi Hapus</h5>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('backend-video.destroy', $videos->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control @error('url') is-invalid @enderror" name="url" placeholder="URL Video" value="{{ old('url') }}"/>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="desc" class="form-control @error('desc') is-invalid @enderror" rows="5">{{ old('desc') }}</textarea>
                                                        @error('desc')
                                                            <div class="invalid-feedback">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
