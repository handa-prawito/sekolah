...
<head>
    ...
    <title>Login Page - Mi.Wachid Hasjim</title>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="/">
                            <img src="{{ asset('Assets/Frontend/img/logoSekolah.png') }}" alt="" style="width: 40px; object-fit:contain;">
                            <h2 class="brand-text text-primary ml-1" style="display: flex; justify-content: center; align-items: center">Mi . Wachid Hasjim</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @endif
                                <h2 class="card-title font-weight-bold mb-1">Welcome to Mi.Wahas 👋</h2>
                                <p class="card-text mb-2">Silakan masuk ke akun anda dibawah sini 😊 </p>
                                <form class="auth-login-form mt-2" action="{{route('login')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#forgotPasswordModal"><small>Lupa Password?</small></a>
                                        </div>
    ...
    <!-- END: Content-->
     ...
     <div class="modal fade" id="forgotPasswordModal" tabindex="-1" role="dialog" aria-labelledby="forgotPasswordModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="POST" action="/send-reset-link" class="modal-content">
                @csrf
                ...
                <div class="modal-body">
                    <p>Silakan masukkan alamat email Anda. Kami akan mengirimkan Anda tautan untuk mengatur ulang kata sandi Anda.</p>
                    <input type="email" id="email" name="email" class="form-control" placeholder="Masukan Email Anda">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-primary" id="sendEmailButton">Kirim Email</button>
                </div>
            </form>
        </div>
    </div>
