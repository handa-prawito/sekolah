            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    ...
                    {{-- <li class="nav-item {{ (request()->is('ranking')) ? 'active' : '' }} ">
                        <a class="d-flex align-items-center" href="{{ route('rankingAdmin') }}"><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Ranking</span>
                        </a>
                    </li> --}}
                ...
                <ul class="menu-content">
                    <li>
                        <a class="d-flex align-items-center" href=""><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Kelas 1</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center" href=""><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Kelas 2</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center" href=""><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Kelas 3</span>
                        </a>
                    </li>
                </ul>
            </li> --}}
